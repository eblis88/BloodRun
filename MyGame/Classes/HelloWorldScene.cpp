...
Scene* HelloWorld::createScene()
{
	...
	HRocker *rocker = HRocker::HRockerWithCenter(ccp(0, 0), 50.0f, spRocker, spRockerBG, false);//创建摇杆 
	rocker->setGameLayer(layer);

	scene->addChild(rocker);//摇杆添加到layer中 
	//this 是个layer 
	...
	scene->addChild(rocker2);//摇杆添加到layer中 
